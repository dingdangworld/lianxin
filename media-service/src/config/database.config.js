...
const config = {
  development: {
    ...baseConfig,
    username: process.env.DB_USER_MEDIA_SERVICE || "root",
    password: process.env.DB_PASSWORD_MEDIA_SERVICE || "Mahmud1334",
    database: process.env.DB_NAME_MEDIA_SERVICE || "lianxin_media",
